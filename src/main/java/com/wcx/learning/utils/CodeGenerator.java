...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://121.199.43.61:33010/merrige-erp-uat?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    private static final String DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    // 数据库用户名
    private static final String USERNAME = "root";
    // 数据库密码
    private static final String PASSWORD = "1Q#!bURw68Vw";
    // @author 值
    private static final String AUTHOR = "吴传祥";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.newretail";
    // xml文件路径
    ...
    public static void main(String[] args) {
        ...
        packageConfig.setModuleName("settlement2");
