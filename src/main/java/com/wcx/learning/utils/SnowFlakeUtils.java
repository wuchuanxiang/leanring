...
//    private final static long START_STMP = 1546272000L;//2019年1月1日
    ...
    private SnowFlakeUtils(long datacenterId, long machineId) {
    ...
    private static class Singleton {
        ...
        public static void init(long machineId){
            instance = new SnowFlakeUtils(9, machineId);
        };
    }
...
//        for (int i = 0; i < 20; i++) {
//            System.out.println(Tester.random(2));
//        }

        SnowFlakeUtils snowFlakeUtils = new SnowFlakeUtils(6, 1);
